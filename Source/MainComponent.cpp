...
MainComponent::MainComponent() : juce::Component()
{
    ...
    addChildComponent(playerNumLabel);
    playerNumLabel.setText("Number of Players:", juce::dontSendNotification);
    playerNumLabel.attachToComponent(&playerNumberButtons[0], false);
    for (int i = 0; i < 4; ++i)
    {
